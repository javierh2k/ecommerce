...
import config from '../webpack/webpack.client.config';
const PORT = 3000;
...
const printInstructions = () => {
  ...
  console.log(`  ${colors.bold('Local:')}\t\thttp://localhost:${colors.bold(PORT)}`);
  console.log(`  ${colors.bold('On Your Network:')}\thttp://${host}:${colors.bold(PORT)}\n`);
